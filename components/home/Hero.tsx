...
function QuickIcon({ name }: { name: QuickIconName }) {
  ...
  const paths: Record<QuickIconName, ReactNode> = {
    season: <><path {...common} d="M7.8 18.2c5.7-.4 9.3-4.1 9.8-10.8-6.6.5-10.2 4.2-9.8 10.8Z" /><path {...common} d="M8 18c2.5-3.3 4.9-5.4 8.5-7" /></>,
    ...
    all: <><path {...common} d="M6.5 9h11l-.7 10H7.2L6.5 9Z" /><path {...common} d="M9 9a3 3 0 0 1 6 0" /></>,
    meal: <><path {...common} d="M5 12h14l-1.2 7H6.2L5 12Z" /><path {...common} d="M8 12V8" /><path {...common} d="M12 12V6" /><path {...common} d="M16 12V8" /></>,
    ...
    <section className="hero" id="best">
      <div className="shell hero-copy fade-up">
        ...
        <div className="hero-actions">
          <Link href="#best" className="button coral">오늘의 추천 상품 보기</Link>
