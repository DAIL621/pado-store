...
- 생성 시각: 2026-07-10T08:55:37.587Z
- 테스트 성공률: 67%
- Go / No-Go: No-Go
- 실제 런칭 가능 여부: 불가
- 주문번호: PADO-20260710-8CC7E95
...
| ⑨ 관리자 주문 확인 | SUCCESS | PADO-20260710-8CC7E95 | screenshots/launch-readiness/09-admin-orders.png |
| ⑩ 주문 상태 변경 | SUCCESS | pending -> paid -> preparing | - |
| ⑪ 송장 입력 | SUCCESS | CJ대한통운 / 123456789012 | - |
| ⑫ 배송중 | SUCCESS | delivery_ready -> shipped | screenshots/launch-readiness/12-admin-shipped.png |
...
| ⑮ 리뷰 요청 준비 | SUCCESS | {"ok":true} | screenshots/launch-readiness/15-review-request.png |
