# PADO STORY Image Guide

## Image Roles

Every product can have up to six primary images:
...
- Hero uses the first available representative image.
...
- Hero: large, product-first, object-fit cover
