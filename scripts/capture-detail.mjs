...
try {
  ...
  const sectionTargets = {
    ...
    timeline: ["#detail-master-timeline, .detail-layout-section", ".detail-master"],
    banner: [".detail-full-bleed-banner, .detail-master-impact", ".detail-master"],
    review: [".detail-review-highlight, .detail-master-review-ready", ".detail-master"],
    finalCta: [".detail-footer-order, .detail-master-final-cta", ".detail-master"],
